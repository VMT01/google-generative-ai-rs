/// A simple dataclass used to configure the generation parameters of [GenerativeModel::generate_content][super::super::generative_models::GenerativeModel::generate_content].
#[derive(Debug)]
